...
useEffect(()=>{
  ...
  const savedata = () => {
    try {
      const serializedLearnDetails = JSON.stringify(learnDetails);
      localStorage.setItem('completeinfo', serializedLearnDetails);
    } catch (error) {
    ...
    <div className='workshop_complete_container'>
      {learnDetails ? (
        <div className='workshop_container'>
          ...
          <img src={learnDetails.RecordSessionLink} alt="img" />
            </div>
          ...
          <div className='workshop_demo_videos_and_details'>
            <div className='demo_container'>
              ...
              <div className='price-container'>
                ...
                {learnDetails.DiscountPrice === "0" ? (
        <Link to={`/Enroll-free/${learnDetails._id}`} onClick={savedata} className='enroll-cta'>Free Enroll Now</Link>
      ) : (
        <Link to={`/Enroll/${learnDetails._id}`} onClick={savedata} className='enroll-cta'>Enroll Now</Link>
      )}
...
{isReviewModalOpen && (
    ...
    {loadingReviews ? (
        ...
        <div className='no-rview-conatiner'>
          <img className='reviewimg' src={noImg} alt="img"/>
