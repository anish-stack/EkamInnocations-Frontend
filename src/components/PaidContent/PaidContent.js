                ...
                {audioBookData && (
                    <>
                        <div className='paid-object-img'>
                            <img src={audioBookData.audioBookThumbnail} alt="img" />
                        </div>
                        <div className='text-paid'>
                            ...
                            <h2>This Is A Paid E-books From @Ekam Innocations</h2>
                            <h3>
                        ...
                        <div className='social-icons'>
                            <ul>
                                <li><Link><img src={img} alt="img" /></Link></li>
                                <li><Link><img src={img2} alt="img" /></Link></li>
                                <li><Link><img src={img4} alt="img" /></Link></li>
                                <li><Link><img src={img5} alt="img" /></Link></li>
                            </ul>
                        </div>
