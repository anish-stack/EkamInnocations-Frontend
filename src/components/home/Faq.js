      ...
      <div className="faq-content">
        ...
        {faqData.map((item, index) => (
          <div key={index} className={`faq-item ${openIndex === index ? 'open' : ''}`} onClick={() => handleToggle(index)}>
            <div className="question">{item.question} <div className='arrow'> ↓</div></div>
